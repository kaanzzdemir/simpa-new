        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    about_text = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    other_number_3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    other_number_2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    other_number_1 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    top_category_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    top_category_name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    product_info_piece = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_info_box_weight = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_info_box_measurement = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_info_shipment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_color = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_img_4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_img_3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    product_img_2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
